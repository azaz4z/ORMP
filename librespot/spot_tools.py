...
class SpotTools:
    ...
    def get_track_bytes(self, track_uri: str) -> bytes:
        """
        Descarga el track completo en formato Ogg Vorbis.
        """
        self._ensure_session()
        ...
        # Read the entire stream byte by byte (returns bytes object)
        return stream.input_stream.stream().read(-1)
